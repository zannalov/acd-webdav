...
var jsDAV_ACD_Changes = require( './changes' );
...
var jsDAV_ACD_Tree = jsDAV_Tree.extend( {
    ...
    initialize: function( options ) {
        ...
        this.acdCache = options.acdCache || new jsDAV_ACD_Fs_Cache( options.tmpDir || jsDAV_Server.DEFAULT_TMPDIR );

        this.acdChanges = options.acdChanges || new jsDAV_ACD_Changes();
        this.acdChanges.tree = this;
        this.acdChanges.acdCache = this.acdChanges.acdCache || this.acdCache;
        this.acdChanges.startPolling( true );
    },
