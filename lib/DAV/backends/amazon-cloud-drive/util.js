...
module.exports.asyncShift = function asyncShift( list , iteratorCallback , finalCallback ) {
    if( 0 === list.length ) {
        return finalCallback();
    }

    var nextValue = list.shift();
    iteratorCallback( nextValue , module.exports.asyncShift.bind( null , list , iteratorCallback , finalCallback ) );
};
