...
var jsDAV_ACD_Directory = jsDAV_ACD_Node.extend( jsDAV_Collection , jsDAV_iQuota , {
    ...
    getChildren: function( cbacdgetchildren ) {
        if( this.cachedChildren ) {
            // Return cached value
            cbacdgetchildren( null , this.cachedChildren );

            // Update cache in background (no error report on fail)
            this._getChildren( function(){} , [] , null );

            // Early exit from this call
            return;
        }
    ...
    _getChildren: function( cbacdgetchildren , _nodes , _nextToken ) {
        ...
        this.acdRequest( {
            ...
            responseCallback: function( error , res , body ) {
                ...
                if( body.nextToken && body.data.length ) {
                    this._getChildren( cbacdgetchildren , _nodes , body.nextToken );
                } else {
