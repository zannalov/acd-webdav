...
jsDAV_ACD_Fs_Cache._asyncShift = function _asyncShift( list , iteratorCallback , finalCallback ) {
    if( 0 === list.length ) {
        return finalCallback();
    }

    var nextValue = list.shift();
    iteratorCallback( nextValue , jsDAV_ACD_Fs_Cache._asyncShift.bind( null , list , iteratorCallback , finalCallback ) );
};
...
jsDAV_ACD_Fs_Cache.prototype.updateMetadata = function updateMetadata( mdata , checkpoint , callback ) {
    ...
    jsDAV_ACD_Fs_Cache._asyncShift( mdata , function( metadata , asyncShiftCallback ) {
...
jsDAV_ACD_Fs_Cache.prototype._updateMetadata = function _updateMetadata( metadata , _updateMetadataCallback ) {
    ...
    this._modifyCachedData( metadata.id , function( err , cachedMetadata , metadataModificationCompleteCallback ) {
        ...
        var changeParentsChildrenList = function( parentList , modificationCallback , nextStep ) {
            jsDAV_ACD_Fs_Cache._asyncShift( parentList , function( parentId , asyncShiftCallback ) {
