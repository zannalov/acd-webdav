...
var jsDAV_ACD_File = jsDAV_ACD_Node.extend( jsDAV_File , {
    ...
    putStream: function( handler , type , cbacdputstream ) {
        ...
        var setupRequestToAcd = function( knownLength ) {
            ...
            jsDAV_ACD_Util.acdRequest( this.tree.amazonAuth , 'contentUrl' , requestOptions , cbacdputstream , handlePutComplete );
    ...
    getStream: function( start , end , cbacdgetstream ) {
        ...
        jsDAV_ACD_Util.acdRequest( this.tree.amazonAuth , 'contentUrl' , requestOptions , cbacdgetstream , function( error , res ) {
            if( error ) {
    ...
    get: function( cbacdgetfile ) {
        ...
        jsDAV_ACD_Util.acdRequest( this.tree.amazonAuth , 'contentUrl' , requestOptions , cbacdgetfile , function( error , res , body ) {
            if( error ) {
